        ...
        <div class="container px-4 px-lg-5">
            ...
            <?php if (isset($_GET["notif"])) { ?>
                <div class="alert alert-success" role="alert">
                    ...
                    <?php if ($_GET["notif"] == 2) echo "Merci de vous etre inscrit !"; ?>
                </div>
            <?php } ?>
            <?php if (isset($_GET["erreur"])) { ?>
                <div class="alert alert-danger" role="alert">
                    <?php if ($_GET["erreur"] == 1) echo "Desolé votre demande de contacte a echouer"; ?>
                </div>
            <?php } ?>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="admin_contact.php">Forms Fetch</a></li>
