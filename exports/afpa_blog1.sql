...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2969970591ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=afpa_blog1&table=blog_posts">`afpa_blog1`.`blog_posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=afpa_blog1&table=blog_comments">`afpa_blog1`.`blog_comments`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="266456455e717e57546973334848284d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="afpa-blog1" targettable="">
            ...
            Queried time
                            ...
                            targetdb="afpa_blog1" targettable="blog_posts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blog_posts`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="afpa_blog1" targettable="blog_comments">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blog_comments`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="afpa_blog1" targettable="blog_posts">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `post_img_url` FROM `blog_posts` WHERE `blog_posts`.`post_ID` = 10</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="afpa_blog1" targettable="blog_posts">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `post_img_url` FROM `blog_posts` WHERE `blog_posts`.`post_ID` = 6</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="afpa_blog1" targettable="blog_posts">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `post_img_url` FROM `blog_posts` WHERE `blog_posts`.`post_ID` = 5</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="afpa_blog1" targettable="blog_posts">
                            <div class="action_content">
